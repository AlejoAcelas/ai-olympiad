# -*- coding: utf-8 -*-
"""IOAI_Morphological_Inflection_On-site_Task.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1VAgruuaHbRsQuDaKtRKktIGd58NFRGEu
...
Here, we ask you to train a machine learning model to perform morphological inflection in Navajo, starting from the approach you developed at home (or the baseline we provide below), and modifying **the attention mechanism** of the model. To replicate a low-resource scenario (commonly occuring in NLP), you will be using only **half the amount of training data** you previously had access to.

### Deliverables:

* solution to warm-up task
* code
* model accuracy on the test set
* a report of up to 300 words on the design of your approach
...
* You can use any known or novel attention methos.
* You are not allowed to use any pre-trained model components or additional training data.

## Warm-up Task

show the attention of different heads for different examples of spanish verbs and

## Main Task

Develop your new approach to morphological reinflection in Navajo below.
"""
...
def sample_data(data):
  random.seed(42)
  return random.sample(data, int(len(data)/2))
...
data['train'] = sample_data(data['train'])
